...
from tasks import _git, _helpers, _task
...
class UpdateGoClientTask(_task.Task):  # pylint: disable=too-few-public-methods
    ...
    def _run(self, dir_):
        ...
        commit_message = _helpers.build_commit_message(
            added, deleted, updated, subject=subject)
        try:
            repo.commit(commit_message,
                        self.github_account.name,
                        self.github_account.email)
        except CallError:
