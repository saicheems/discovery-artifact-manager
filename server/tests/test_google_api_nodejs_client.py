...
from tasks import _accounts, _git, google_api_nodejs_client
from tests import common

_NPM_ACCOUNT = _accounts.NpmAccount('auth_token')
...
def test_release_major(clone_from_github_mock,
    ...
    assert manager.mock_calls == [
        ...
        call.check_output(['rm', '-rf', 'latest'], cwd='/tmp/google-api-nodejs-client'),
        call.check_output(['cp', '-r', 'doc/googleapis/21.0.0'], cwd='/tmp/google-api-nodejs-client'),
        call.check_output(['cp', '-r', 'doc/googleapis/21.0.0', '21.0.0'], cwd='/tmp/google-api-nodejs-client'),
